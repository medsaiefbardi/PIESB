...
CLUSTERED_DATA_PATH = (
    "C:/Users/Skander/Desktop/Projet-Etudiant/scripts/data/processed/clustered_data.csv"
)
...
if (
    "moy_bac" not in data.columns
    or "niveau_courant_et" not in data.columns
    or "Cluster" not in data.columns
):
    print(
        "The required columns 'moy_bac', 'niveau_courant_et', and 'Cluster' are not available in the dataset."
    )
else:
...
cluster_summary.columns = [
    ...
    "Mean Moy Bac",
    "Median Moy Bac",
    "Most Common Academic Level",
    "Most Common Gouvernorat",
]
